...
class Callable extends Function {
  static get CALL() { // getter for CALL symbol
    return CALL
  }
  get [Symbol.toStringTag]() { // creates stringTag (Object.prototype.toString.call(new Callable()) === [object Callable])
    return "Callable"
  }
  constructor(property = CALL) {
    ...
    this[BOUND] = this.bind({ // binds to property, bound symbol and this
      a: this,
      b: BOUND,
      c: property
    })
